...
current_path = 'C:/D_Disk/data_competition/Santander_Value_Prediction/'
#from top scoring kernels and blends - for testing only
sub1 = pd.read_csv(current_path + '/input/best-ensemble-score-made-available-0-68/SHAZ13_ENS_LEAKS.csv')
sub2 = pd.read_csv(current_path + '/input/best-ensemble-score-made-available-0-67/SHAZ13_ENS_LEAKS.csv')
sub3 = pd.read_csv(current_path + '/input/feature-scoring-vs-zeros/leaky_submission.csv')

#standard
train = pd.read_csv(current_path + '/input/santander-value-prediction-challenge/train.csv')
test = pd.read_csv(current_path + '/input/santander-value-prediction-challenge/test.csv')
...
test['target'] /= folds
test[['ID', 'target']].to_csv('./submission_example2.csv', index=False)
