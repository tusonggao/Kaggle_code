...
start_t = time.time()
train_df = pd.read_csv('C:/D_Disk/data_competition/gamer_value/data/tap_fun_train.csv', 
                       index_col=0, header=0)
test_df = pd.read_csv('C:/D_Disk/data_competition/gamer_value/data/tap_fun_test.csv',
                      index_col=0, header=0)
